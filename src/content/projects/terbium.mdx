...
An unfinished compiler for the Terbium programming language.

## Specification

A semi-formal language specification can be found [here](https://jay3332.gitbook.io/terbium/spec). 
The specification may be outdated with this specific implementation.

## Why (do I want to make) Terbium?
