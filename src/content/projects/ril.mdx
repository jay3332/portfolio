...
thumbnail: /images/ril/thumbnail.png
skills:
- rust
- image processing
repo: jay3332/ril
...
Every day, a staggering 14 billion images flow through digital systems. <br /> How should our software handle these images?
</div>
...
<summary><u class="cursor-pointer hover:text-white transition">View benchmarks</u></summary>
...
<summary><u class="cursor-pointer hover:text-white transition">Code samples</u></summary>
